...
int StageInitialize(void)
{
	...
	/*星のエフェクトロード:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
	StarImage = LoadGraph("images/stareffect.png");
...
void StageDraw(void) {
	...
	/*DrawRotaGraph(GetMousePositionX(), GetMousePositionY(), 0.2, 0.0, StarImage, TRUE);*/
...
/*星のエフェクトフェードアウト:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
/*void FadeOutStar(void)
{
	if (GetKeyFlg(MOUSE_INPUT_LEFT)) 
	{
		static int BlendMode = 145;
...
void SelectBlock(void)
{
	...
	if (ClickStatus == E_SECOND)
	{
		...
		Block[Select[NEXT_CURSOR].y + 1][Select[NEXT_CURSOR].x + 1].image = Block[Select[TMP_CURSOR].y + 1][Select[TMP_CURSOR].x + 1].image = Block[Select[TMP_CURSOR].y + 1][Select[TMP_CURSOR].x + 1].image;
	...
	for (i = 1; i < HEIGHT - 1; i++)
	{
		for (j = 1; j < WIDTH - 1; j++)
		{
			if (Block[i][j].image == 0)
			{
				...
				DrawRotaGraph(Block[i][j].x + 30, Block[i][j].y + 25, 0.2, (k * (DX_PI / 180)), StarImage, TRUE);
			}
		}
	}
